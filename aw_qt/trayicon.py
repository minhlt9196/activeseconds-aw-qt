...
def get_env() -> Dict[str, str]:
    ...
    https://github.com/TimeBench/timebench/issues/208#issuecomment-417346407
    """
...
class TrayIcon(QSystemTrayIcon):
    def __init__(
        ...
        self.setToolTip("TimeBench" + (" (testing)" if testing else ""))
    ...
    def _build_rootmenu(self) -> None:
        ...
        # This check is an attempted solution to: https://github.com/TimeBench/timebench/issues/62
        ...
        if exitIcon.availableSizes():
            menu.addAction(exitIcon, "Quit TimeBench", lambda: exit(self.manager))
        else:
            menu.addAction("Quit TimeBench", lambda: exit(self.manager))
...
def run(manager: Manager, testing: bool = False) -> Any:
    ...
    if not QSystemTrayIcon.isSystemTrayAvailable():
        QMessageBox.critical(
            None,
            "Systray",
            "I couldn't detect any system tray on this system. Either get one or run the TimeBench modules from the console.",
        )
        sys.exit(1)
